...
const SERVICE_DESCRIPTIONS: Record<number, string> = {
    1: 'غسيل، تلميع، صيانة دورية، وإصلاح الأعطال الميكانيكية والكهربائية للسيارات.', // Cars
    2: 'صيانة وتركيب وحدات التكييف المركزية والوحدات المنفصلة وتنظيف الفلاتر.', // AC
    3: 'تأسيس شبكات الكهرباء، تركيب الإضاءة، وإصلاح الأعطال الكهربائية المنزلية.', // Electricity
    11: 'كشف التسريبات، تأسيس السباكة، تركيب الأدوات الصحية وصيانة المضخات.', // Plumbing
    4: 'تنظيف شامل للمنازل، الشقق، الفلل، غسيل السجاد والكنب والواجهات.', // Cleaning
    5: 'استشارات قانونية، صياغة عقود، وتمثيل قانوني في مختلف القضايا.', // Law
    6: 'صيانة الغسالات، الثلاجات، الأفران، وجميع الأجهزة المنزلية الكبيرة والصغيرة.', // Appliances
    7: 'دروس تقوية لجميع المراحل الدراسية، تعليم لغات، ودورات تدريبية متخصصة.', // Education
    8: 'تنسيق الحدائق، زراعة الورود والأشجار، تركيب شبكات الري والعشب الصناعي.', // Gardening
    9: 'تصميم جرافيك، برمجة مواقع وتطبيقات، وتسويق إلكتروني.', // Design & Code
    10: 'نقل عفش، فك وتركيب الأثاث، تغليف احترافي ونقل آمن.', // Moving
};
