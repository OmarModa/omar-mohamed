...
export const CarIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    <path d="M7 16.5h10" />
    <path d="M15 7.5c0-3.1-1.4-5-2.5-5S10 4.4 10 7.5" />
  </svg>
);

export const AcIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M12 3a2.4 2.4 0 0 0-2.2 1.5l-6.5 12A2.4 2.4 0 0 0 5.5 20H12h6.5a2.4 2.4 0 0 0 2.2-3.5l-6.5-12A2.4 2.4 0 0 0 12 3Z" />
    <path d="M12 10v11" />
    <path d="M17.7 10H6.3" />
  </svg>
);
...
export const GavelIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <path d="m20.5 7.5-3.4 3.4"/>
        <path d="M4 14.5 12 12l.5 3.5-3.5 3.5-6-6Z"/>
    </svg>
);
...
export const TruckIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <path d="M15 18H9"/>
        <path d="M19 18h2a1 1 0 0 0 1-1v-3.63a1 1 0 0 0-.44-.82l-3.56-2.55a1 1 0 0 0-1.56.82V18Z"/>
...
export const DropIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M12 2.69l5.74 5.74c.84.84 1.53 1.86 2.03 2.98.51 1.12.78 2.33.78 3.57 0 2.27-.9 4.44-2.51 6.05C16.44 22.63 14.27 23.53 12 23.53c-2.27 0-4.44-.9-6.05-2.51C4.35 19.41 3.45 17.24 3.45 14.97c0-1.24.27-2.45.78-3.57.5-1.12 1.19-2.14 2.03-2.98L12 2.69z"/>
    </svg>
);
